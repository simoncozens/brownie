...
class BaseNode: NSObject, NSCoding, NSCopying {
    static let DATES_NAME = "DATES"
    static let SOURCES_NAME = "SOURCES"
    static let PLACES_NAME = "PLACES"
    static let TAGS_NAME = "TAGS"
    ...
    var isSpecialGroup: Bool {
        return (self.nodeTitle == BaseNode.DATES_NAME || self.nodeTitle == BaseNode.SOURCES_NAME)
    }
    ...
    var isFolder: Bool { return self.url != nil }
